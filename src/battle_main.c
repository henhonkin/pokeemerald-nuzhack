...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(TEAM_AQUA, "TEAM AQUA", ITEM_NET_BALL),
    ...
    TRAINER_CLASS(AQUA_ADMIN, "AQUA ADMIN", 10, ITEM_DIVE_BALL),
    ...
    TRAINER_CLASS(AROMA_LADY, "AROMA LADY", 10, ITEM_NEST_BALL),
    ...
    TRAINER_CLASS(PARASOL_LADY, "PARASOL LADY", 10, ITEM_LOVE_BALL),
    ...
    TRAINER_CLASS(SCOTT, "ZONE OWNER", 50, ITEM_CHERISH_BALL),
};
