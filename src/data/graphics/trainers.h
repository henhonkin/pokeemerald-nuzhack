...
const u32 gTrainerFrontPic_Scott[] = INCBIN_U32("graphics/trainers/front_pics/scott.4bpp.lz");
const u32 gTrainerPalette_Scott[] = INCBIN_U32("graphics/trainers/front_pics/scott.gbapal.lz");
