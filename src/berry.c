...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 20,
        .maxYield = YIELD_RATE(90, 5, 15, 20),
        .minYield = YIELD_RATE(15, 2, 4, 4),
    ...
    [ITEM_LEPPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 28,
        .maxYield = YIELD_RATE(90, 5, 15, 22),
        .minYield = YIELD_RATE(15, 2, 2, 2),
    ...
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_GREEN,
        .size = 34,
        .maxYield = YIELD_RATE(90, 5, 20, 18),
        .minYield = YIELD_RATE(15, 2, 3, 2),
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_YELLOW,
        .size = 95,
        .maxYield = YIELD_RATE(90, 5, 20, 27),
        .minYield = YIELD_RATE(15, 2, 3, 3),
    ...
    [ITEM_FIGY_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 100,
        .maxYield = YIELD_RATE(90, 5, 15, 15),
        .minYield = YIELD_RATE(15, 1, 3, 3),
    ...
    [ITEM_RAZZ_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 120,
        .maxYield = YIELD_RATE(90, 10, 15, 20),
        .minYield = YIELD_RATE(15, 2, 3, 4),
    ...
    [ITEM_POMEG_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 135,
        .maxYield = YIELD_RATE(90, 5, 20, 26),
        .minYield = YIELD_RATE(15, 1, 1, 2),
    ...
    [ITEM_CORNN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_PURPLE,
        .size = 75,
        .maxYield = YIELD_RATE(90, 10, 15, 15),
        .minYield = YIELD_RATE(15, 2, 3, 3),
    ...
    [ITEM_SPELON_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 133,
        .maxYield = YIELD_RATE(90, 15, 15, 15),
        .minYield = YIELD_RATE(15, 2, 3, 3),
    ...
    [ITEM_CHILAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_YELLOW,
        .size = 34,
        .maxYield = YIELD_RATE(90, 5, 20, 10),
        .minYield = YIELD_RATE(15, 1, 3, 2),
    ...
    [ITEM_LIECHI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 111,
        .maxYield = YIELD_RATE(90, 5, 10, 13),
        .minYield = YIELD_RATE(15, 1, 1, 2),
    ...
    [ITEM_LANSAT_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 97,
        .maxYield = YIELD_RATE(90, 5, 5, 7),
        .minYield = YIELD_RATE(15, 1, 1, 1),
...
static u8 CalcBerryYieldInternal(u16 max, u16 min, u8 water)
{
    ...
    if (water == 0 || OW_BERRY_MOISTURE)
        return min + (Random() % (max - min +1)) / (NUM_WATER_STAGES+1);
    else
    {
